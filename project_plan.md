...
gantt
    ...
    section Подготовка
    Детализация требований                      :crit, prep1, 2025-05-01, 14d
    Согласование API и интерфейсов              :crit, prep2, after prep1, 21d
    Проектирование ML-модели классификации      :prep3, 2025-05-10, 28d
    Подготовка тестовых данных                  :prep4, 2025-05-15, 14d
    ...
    ✓ Готовность MVP-функционала                :milestone, 2025-07-31, 0d
    ...
    Пользовательское тестирование (закрытое)    :test4, 2025-08-15, 21d
    ...
    Подготовка инфраструктуры                   :deploy2, 2025-09-01, 14d
    ...
    ✓ Полный запуск на рынок                    :milestone, 2025-10-31, 0d
```
